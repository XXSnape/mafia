...
🛎️Регистрацию можно отменить, введя команду /revoke. Максимум регистрация длится 5 минут, затем игра автоматически начнётся. Игру можно запустить раньше, введя команду /game.
