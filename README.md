...
🎟️Присоединиться к игре можно так же нажав на кнопку под этим сообщением, а выйти с помощью команды /leave в группе
...
🤑4) Игрок может победить, даже если умер днём или ночью в зависимости от особенностей самой роли или группиро
...
- Показывать имена игроков, участвовавших в подтверждении - если данная настройка включена, после результатов подтверждения бот пришлен информацию об участниках и их выборе в чат
...
- Писать в личку о ночных гостях - если кто-то взаимодействовал ночью с игроком, бот игроку присылает информацию об этом. Если настройка выключена, бот сообщит, что к игроку кто-то приходил, но не укажет роли
