...
class BaseRouter(RouterHelper):
    ...
    async def how_to_set_up_game(self):
        text = (
            ...
            "● Ускорять наступление дня и подтверждения — можно выставить длительность ночи 3 минуты, но если включена данная настройка, и все игроки успели сделать ход, ночь может завершиться через секунд 20. То же самое с этапом голосования\n\n"
