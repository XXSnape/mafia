...
class BaseRouter(RouterHelper):
    ...
    async def how_to_set_up_game(self):
        text = (
            ...
            "● Показывать имена игроков, участвовавших в подтверждении - "
            ...
            f"● Писать в личку о ночных гостях - если кто-то взаимодействовал ночью с игроком, бот игроку присылает информацию об этом (об исключениях в разделе «{ROLES_SELECTION}»). Если настройка выключена, бот сообщит, что к игроку кто-то приходил, но не укажет роли\n"
