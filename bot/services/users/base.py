...
class BaseRouter(RouterHelper):
    ...
    async def how_to_start_game(self):
        text = (
            ...
            f"/{BotCommands.subscribe.name}, бот будет присылать в личку сообщение с дальнейшими инструкциями.\n\n"
    ...
    async def how_to_play(self):
        text = (
            ...
            f"когда все живые участники введут /{BotCommands.leave.name}.\n\n"
