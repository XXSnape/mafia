...
class BaseRouter(RouterHelper):
    ...
    async def how_to_set_up_game(self):
        text = (
            ...
            f"Чтобы персонально настроить игру, введите команду /{PrivateCommands.my_settings.name} "
            ...
            "присылает в чат информацию об одном из его убийц (не всех, кто пытался его убить). Если эта настройка будет выключена, информация будет скрыта\n\n"
    ...
    async def how_to_set_up_specific_group(self):
        text = (
            ...
            f"/{GroupCommands.settings.name} в группу. "
