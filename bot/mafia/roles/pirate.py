...
class Pirate(
    ...
    def role_description(self) -> RoleDescription:
        return RoleDescription(
            ...
            "Если меченый на подтверждении линчевания (неважен выбор на первичном "
            "голосовании) проголосовал за, "
            "и смертник погиб по итогу, меченый умирает вместе с ним перед "
            "началом следующей ночи, если игра не завершится раньше.",
